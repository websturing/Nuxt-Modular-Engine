...
<template>
    <div
        ...
        <!-- Center Content -->
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 hidden md:flex">
            <!-- Search -->
            <div class="w-56 focus-within:w-80 md:focus-within:w-96 transition-all duration-300 relative">
                <div class="relative">
